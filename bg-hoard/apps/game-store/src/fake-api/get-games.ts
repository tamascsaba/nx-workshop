const games = [
  {
    ...
    image: '/beans.png', // 'https://media.giphy.com/media/xUNda3pLJEsg4Nedji/giphy.gif',
    description:
  ...
  },
  {
    id: 'chess-pie',
    name: 'Chess Pie',
    image: '/chess.png', // 'https://media.giphy.com/media/iCZyBnPBLr0dy/giphy.gif',
  ...
  },
  {
    id: 'purrfection',
    name: 'Purrfection',
    image: '/cat.png', // 'https://media.giphy.com/media/12xMvwvQXJNx0k/giphy.gif',
